...
func avanzar(dado):
	...
	for i in range(dado):
		...
		# Arriba - Casilla 10
			...
			currPos[1] -= 48.5
		elif currPos[0] < 561 && currPos[1] > 456 && currPos[1] < 520.5:
			currPos[0] += 48.5
		# Arriba - Casilla 20
		elif currPos[0] > 561 && currPos[0] < 603 && currPos[1] < 487 && currPos[1] > 427:
			currPos[1] -= 48.5
		...
		# Arriba - Casilla 30
			...
			currPos[0] += 48.5
		# Arriba - Casilla 40
		elif currPos[0] > 561 && currPos[0] < 603 && currPos[1] > 330 && currPos[1] < 390:
			currPos[1] -= 48.5
		...
		# Arriba - Casilla 50
			...
			currPos[1] -= 48.5
		elif currPos[0] < 561 && currPos[1] > 233 && currPos[1] < 293:
			currPos[0] += 48.5
		# Arriba - Casilla 60
		elif currPos[0] > 561 && currPos[0] < 603 && currPos[1] > 233 && currPos[1] < 293:
			currPos[1] -= 48.5
		...
		# Arriba - Casilla 70
			...
			currPos[1] -= 48.5
		elif currPos[0] < 561 && currPos[1] > 136 && currPos[1] < 196:
			currPos[0] += 48.5
		# Arriba - Casilla 80
		elif currPos[0] > 561 && currPos[0] < 603 && currPos[1] > 136 && currPos[1] < 196:
			currPos[1] -= 48.5
		...
		# Arriba - Casilla 90
			...
			currPos[1] -= 48.5
		elif currPos[0] < 561 && currPos[1] > 39 && currPos[1] < 99:
			currPos[0] += 48.5
